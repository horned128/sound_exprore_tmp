...
gpt_instance_ctrl_t g_servo_pwm_rr_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_servo_pwm_rr_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t g_servo_pwm_rr_extend =
		{
...
#if 0
    .p_pwm_cfg             = &g_servo_pwm_rr_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_servo_pwm_rr_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts =
		(uint32_t) 0x5b8d80, .duty_cycle_counts = 0x668a0, .source_div =
		(timer_source_div_t) 0, .channel = 11, .p_callback = NULL,
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_servo_pwm_rr_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
const timer_instance_t g_servo_pwm_rr = { .p_ctrl = &g_servo_pwm_rr_ctrl,
		.p_cfg = &g_servo_pwm_rr_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_servo_pwm_rl_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_servo_pwm_rl_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_servo_pwm_rl_extend =
		{
				.gtioca = { .output_enabled = false, .stop_level =
						GPT_PIN_LEVEL_LOW }, .gtiocb = { .output_enabled = true,
						.stop_level = GPT_PIN_LEVEL_LOW }, .start_source =
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT13_COMPARE_F,
				...
				.compare_match_value = { (uint32_t) 0x0, /* CMP_A */
						...
						GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_servo_pwm_rl_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_servo_pwm_rl_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts =
		(uint32_t) 0x5b8d80, .duty_cycle_counts = 0x668a0, .source_div =
		(timer_source_div_t) 0, .channel = 13, .p_callback = NULL,
/** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_servo_pwm_rl_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_servo_pwm_rl = { .p_ctrl = &g_servo_pwm_rl_ctrl,
		.p_cfg = &g_servo_pwm_rl_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_servo_pwm_fr_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_servo_pwm_fr_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_servo_pwm_fr_extend =
		{
				.gtioca = { .output_enabled = false, .stop_level =
						GPT_PIN_LEVEL_LOW }, .gtiocb = { .output_enabled = true,
						.stop_level = GPT_PIN_LEVEL_LOW }, .start_source =
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT12_COMPARE_F,
				...
				.compare_match_value = { (uint32_t) 0x0, /* CMP_A */
						...
						GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_servo_pwm_fr_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_servo_pwm_fr_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts =
		(uint32_t) 0x5b8d80, .duty_cycle_counts = 0x668a0, .source_div =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_servo_pwm_fr_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_servo_pwm_fr = { .p_ctrl = &g_servo_pwm_fr_ctrl,
		.p_cfg = &g_servo_pwm_fr_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_motor_pwm_lpwm_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_motor_pwm_lpwm_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_motor_pwm_lpwm_extend =
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT7_COMPARE_F,
				...
				.compare_match_value = { (uint32_t) 0x0, /* CMP_A */
						...
						GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_motor_pwm_lpwm_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_motor_pwm_lpwm_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.00005 seconds. Actual duty: 0%. */.period_counts =
		(uint32_t) 0x3a98, .duty_cycle_counts = 0x0, .source_div =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_motor_pwm_lpwm_extend, .cycle_end_ipl =
				(BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_motor_pwm_lpwm = { .p_ctrl = &g_motor_pwm_lpwm_ctrl,
		.p_cfg = &g_motor_pwm_lpwm_cfg, .p_api = &g_timer_on_gpt };
...
const timer_cfg_t g_motor_pwm_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.00005 seconds. Actual duty: 0%. */.period_counts =
		(uint32_t) 0x3a98, .duty_cycle_counts = 0x0, .source_div =
		(timer_source_div_t) 0, .channel = 10, .p_callback = NULL,
/** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_motor_pwm_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_motor_pwm = { .p_ctrl = &g_motor_pwm_ctrl, .p_cfg =
		&g_motor_pwm_cfg, .p_api = &g_timer_on_gpt };
gpt_instance_ctrl_t g_servo_pwm_fl_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_servo_pwm_fl_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_servo_pwm_fl_extend =
		{
				.gtioca = { .output_enabled = false, .stop_level =
						GPT_PIN_LEVEL_LOW }, .gtiocb = { .output_enabled = true,
						.stop_level = GPT_PIN_LEVEL_LOW }, .start_source =
    ...
    .compare_match_f_irq   = VECTOR_NUMBER_GPT9_COMPARE_F,
				...
				.compare_match_value = { (uint32_t) 0x0, /* CMP_A */
						...
						GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg             = &g_servo_pwm_fl_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_servo_pwm_fl_cfg = { .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 7%. */.period_counts =
		(uint32_t) 0x5b8d80, .duty_cycle_counts = 0x668a0, .source_div =
		(timer_source_div_t) 0, .channel = 9, .p_callback = NULL,
/** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
		.p_context = (void*) &NULL,
#endif
		.p_extend = &g_servo_pwm_fl_extend, .cycle_end_ipl = (BSP_IRQ_DISABLED),
...
/* Instance structure to use this module. */
const timer_instance_t g_servo_pwm_fl = { .p_ctrl = &g_servo_pwm_fl_ctrl,
		.p_cfg = &g_servo_pwm_fl_cfg, .p_api = &g_timer_on_gpt };
ipc_instance_ctrl_t g_actuator_ipc_ctrl;

/** IPC configuration */
const ipc_cfg_t g_actuator_ipc_cfg = { .channel = 0, .p_callback =
		actuator_ipc_callback,
#if defined(NULL)
                .p_context = NULL,
#else
		.p_context = (void*) &NULL,
