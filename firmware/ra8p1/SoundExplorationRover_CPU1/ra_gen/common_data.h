...
extern const external_irq_instance_t g_encoder_b_irq;

/** Access the ICU instance using these structures when calling API functions directly (::p_api is not used). */
extern icu_instance_ctrl_t g_encoder_b_irq_ctrl;
extern const external_irq_cfg_t g_encoder_b_irq_cfg;

#ifndef jga25_encoder_b_callback
void jga25_encoder_b_callback(external_irq_callback_args_t *p_args);
#endif
/** External IRQ on ICU Instance. */
extern const external_irq_instance_t g_encoder_a_irq;

/** Access the ICU instance using these structures when calling API functions directly (::p_api is not used). */
extern icu_instance_ctrl_t g_encoder_a_irq_ctrl;
extern const external_irq_cfg_t g_encoder_a_irq_cfg;

#ifndef jga25_encoder_a_callback
